...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2024 a las 01:38:34
...
-- Base de datos: `bases`
--
CREATE DATABASE IF NOT EXISTS `bases` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bases`;
--
...
(1, 'maria', 'rodriguez rengifo', 2, '2024-10-01', '2024-10-21', 'mariro@gmail.com'),
(2, 'luisa', 'castañeda pineda', 2, '2024-10-03', '2024-10-21', 'lui@gmail.com'),
(3, 'karol', 'pinos pinos', 2, '2024-10-19', '2024-10-21', 'kapi@gmail.com'),
(4, 'miguel', 'romero romero', 1, '2024-10-25', '2024-10-21', 'miromero@gmail.com');
...
CREATE TABLE `estudiantes` (
  ...
  `latitud_residencia` varchar(100) DEFAULT NULL,
  `longitud_residencia` varchar(100) DEFAULT NULL,
  `direccion_trabajo` text DEFAULT NULL,
  `latitud_trabajo` varchar(100) DEFAULT NULL,
  `longitud_trabajo` varchar(100) DEFAULT NULL
...
INSERT INTO `estudiantes` (`cedula`, `nombres`, `apellidos`, `direccion_residencia`, `latitud_residencia`, `longitud_residencia`, `direccion_trabajo`, `latitud_trabajo`, `longitud_trabajo`) VALUES
('0202', 'koko', 'lpio', 'calle3', '5.965753671065536', '-75.45677190782072', 'calle 39', '7.318881730366756', '-72.99557067001126'),
('1023', 'Espa', 'lolo', 'calle1', '-34.39536614381781', '150.65402304240843', 'calle10', '-34.40004039603824', '150.66433045171925'),
('11111', 'coco', 'marru', 'Transversal 94', '-34.37758743674281', '150.64023688245518', 'calle15', '-32.602361666817515', '144.44357732499535'),
('78945', 'josé', 'maria', 'Transversal 94', '-34.32756015705253', '150.88645299752676', 'calle67', '-34.39922596178233', '150.65552620626625');
...
--
CREATE DATABASE IF NOT EXISTS `gestion_usuarios` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
--
CREATE DATABASE IF NOT EXISTS `loginvaidroll7` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `loginvaidroll7`;
...
--
-- Base de datos: `marimar`
--
CREATE DATABASE IF NOT EXISTS `marimar` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `marimar`;
...
--
-- Disparadores `orderdetails`
--
DELIMITER $$
CREATE TRIGGER `UpdateStockAfterInsert` AFTER INSERT ON `orderdetails` FOR EACH ROW BEGIN
    UPDATE Products
...
(78, 'Chai', 1, 1, '10 boxes x 20 bags', 18);
...
('root', '[{\"db\":\"escuela\",\"table\":\"estudiantes\"},{\"db\":\"northwind\",\"table\":\"products\"},{\"db\":\"northwind\",\"table\":\"orders\"},{\"db\":\"northwind\",\"table\":\"orderdetails\"},{\"db\":\"northwind\",\"table\":\"employees\"},{\"db\":\"northwind\",\"table\":\"customers\"},{\"db\":\"northwind\",\"table\":\"categories\"},{\"db\":\"vaicrud1\",\"table\":\"usuarios\"},{\"db\":\"sistema_usuarios\",\"table\":\"usuarios\"},{\"db\":\"usuarios_db\",\"table\":\"usuarios\"}]');
...
('rol', 'admin', 'id_cargo', 'rol', 'cargo', 'id');
...
('root', '2024-11-08 00:21:19', '{\"Console\\/Mode\":\"show\",\"lang\":\"es\",\"Console\\/Height\":-2.0136200000000004,\"NavigationWidth\":230}');
...
-- Base de datos: `rol`
--
CREATE DATABASE IF NOT EXISTS `rol` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `rol`;
...
INSERT INTO `admin` (`id`, `Nombre`, `usuario`, `contraseña`, `id_cargo`) VALUES
(1, 'gabriel', 'gabriel', '12345', 1),
(2, 'maria', 'mariavaldez', '123456', 2);
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`id_cargo`) REFERENCES `cargo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
--
...
--
CREATE DATABASE IF NOT EXISTS `vaicrud1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vaicrud1`;
...
(32448, 'johan', 'juan@gmail.com', 2147483647),
(32449, 'javier', 'elcoste@gmail.com', 2147483647);
